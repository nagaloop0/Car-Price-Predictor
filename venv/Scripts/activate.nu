...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\pulag\PycharmProjects\quickr predictor\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\pulag\PycharmProjects\quickr predictor\venv\Scripts\deactivate.nu'
